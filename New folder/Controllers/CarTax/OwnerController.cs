...
namespace Avarez.Controllers.CarTax
{
    ...
    public class OwnerController : Controller
    {
        ...
        public ActionResult EstelamSabt(string CodeMeli)
        {
            try
            {
                InSabt.InternalSabtWebServise a = new InSabt.InternalSabtWebServise();
                string p = a.GetData(CodeMeli, "CArtaXWebSrv");
                if (p != null)
        ...
        public ActionResult Save(Models.tblOwner Owner)
        {
            try
            {
                Models.ComplicationsCarDBEntities Car = new Models.ComplicationsCarDBEntities();
