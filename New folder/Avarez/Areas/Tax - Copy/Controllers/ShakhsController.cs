...
namespace Avarez.Areas.Tax.Controllers
{
    public class ShakhsController : Controller
    {
        ...
        {
            Models.cartaxtest2Entities p = new Models.cartaxtest2Entities();
            var q = p.prs_tblShakhsHaghighi_HoghoghiSelect("fldId", Id.ToString(), 0).FirstOrDefault();
        ...
        public ActionResult Read(StoreRequestParameters parameters)
        {
            ...
            if (filterHeaders.Conditions.Count > 0)
            {
                ...
                foreach (var item in filterHeaders.Conditions)
                {
                    ...
                    if (data != null)
                        data1 = p.prs_tblShakhsHaghighi_HoghoghiSelect(field, searchtext, 100).ToList();
                    else
                        data = p.prs_tblShakhsHaghighi_HoghoghiSelect(field, searchtext,  100).ToList();
                }
            ...
            {
                data = p.prs_tblShakhsHaghighi_HoghoghiSelect("", "", 100).ToList();
            }
        ...
        public ActionResult Save(Models.prs_tblShakhsHaghighi_HoghoghiSelect shakhs)
        {
            ...
            try
            {
                ...
                var q = m.prs_tblShakhsHaghighi_HoghoghiSelect("fldNationalCode", shakhs.fldNationalCode, 0).Where(l => l.fldOwnerId == Convert.ToInt32(Session["TarafGharardadId"])).FirstOrDefault();
                if (shakhs.fldId == 0)
                { //ذخیره
                    if (q != null)
                    {
                ...
                { //ویرایش
                    ...
                    {
                        var q2 = m.prs_tblShakhsHaghighi_HoghoghiSelect("fldId", shakhs.fldId.ToString(), 0).FirstOrDefault();
