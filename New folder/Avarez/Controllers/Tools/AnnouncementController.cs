...
namespace Avarez.Controllers.Tools
{
    public class AnnouncementController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            if (Permossions.haveAccess(Convert.ToInt32(Session["UserId"]), 282))
            {
                return PartialView();
            }
            else
        ...
        public ActionResult Fill([DataSourceRequest] DataSourceRequest request)
        {
            ...
            var q = m.sp_AnnouncementManagerSelect("", "", 30, Convert.ToInt32(Session["UserId"]), Session["UserPass"].ToString()).ToList().ToDataSourceResult(request);
            return Json(q);
        ...
        {//جستجو
            string[] _fiald = new string[] { "fldId", "fldCountryDivisonTempName", "fldDate", "fldSubject" };
            string[] searchType = new string[] { "%{0}%", "{0}%", "{0}" };
            string searchtext = string.Format(searchType[searchtype], value);
            Models.cartaxEntities m = new Models.cartaxEntities();
            var q = m.sp_AnnouncementManagerSelect(_fiald[Convert.ToInt32(field)], searchtext, top, Convert.ToInt32(Session["UserId"]), Session["UserPass"].ToString()).ToList();
        ...
        {//نمایش اطلاعات جهت رویت کاربر
            try
            {
                ...
                return Json(new
                {
                    ...
                    fldShowStatus = Announcement.fldShowStatus,
                    fldCountryDivisonTempID = Announcement.fldCountryDivisonTempID,
                    fldDate = Announcement.fldDate,
