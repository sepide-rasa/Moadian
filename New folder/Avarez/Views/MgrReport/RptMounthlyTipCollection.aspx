...
<%{
      ...
      Collection.Fill(dt.sp_MonthlyCollectionTipChart, Convert.ToInt32(Session["Sal"]), Convert.ToInt32(Session["UserMnu"]));
      ...
      WebReport1.Report.Load(AppDomain.CurrentDomain.BaseDirectory + @"\Reports\RptMonthlyTipChart.frx");
      ...
      WebReport1.Report.SetParameterValue("year", Session["Sal"].ToString());
