...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    گزارش تفکیک در آمد به ماه و سال
</asp:Content>
...
<%{
      ...
      MonthlyChart.Fill(dt.sp_RptMonthlyChart, Convert.ToInt32(Session["Sal"]), Convert.ToInt32(Session["UserMnu"]));
      ...
      WebReport1.Report.Load(AppDomain.CurrentDomain.BaseDirectory + @"\Reports\RptMonthlyChart.frx");
