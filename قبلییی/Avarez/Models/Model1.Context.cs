...
namespace Avarez.Models
{
    ...
    public partial class cartaxEntities : DbContext
    {
        ...
        public virtual int sp_tblGuestInfoInsert(string fldName, string fldFamily, string fldCodeMeli, string fldMobile, Nullable<int> fldMunId, string fldUserName, string fldPasssword, string fldDesc)
        {
            var fldNameParameter = fldName != null ?
                new ObjectParameter("fldName", fldName) :
                new ObjectParameter("fldName", typeof(string));
            ...
            var fldPassswordParameter = fldPasssword != null ?
                new ObjectParameter("fldPasssword", fldPasssword) :
                new ObjectParameter("fldPasssword", typeof(string));
    
            var fldDescParameter = fldDesc != null ?
                new ObjectParameter("fldDesc", fldDesc) :
                new ObjectParameter("fldDesc", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_tblGuestInfoInsert", fldNameParameter, fldFamilyParameter, fldCodeMeliParameter, fldMobileParameter, fldMunIdParameter, fldUserNameParameter, fldPassswordParameter, fldDescParameter);
        }
    
        public virtual ObjectResult<sp_tblGuestInfoSelect> sp_tblGuestInfoSelect(string fieldName, string value, string value2, Nullable<int> h)
        {
            var fieldNameParameter = fieldName != null ?
                new ObjectParameter("FieldName", fieldName) :
                new ObjectParameter("FieldName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_tblGuestInfoSelect>("sp_tblGuestInfoSelect", fieldNameParameter, valueParameter, value2Parameter, hParameter);
        }
    
        public virtual int sp_tblGuestInfoUpdate(Nullable<int> fldId, string fldName, string fldFamily, string fldCodeMeli, string fldMobile, Nullable<int> fldMunId, string fldPasssword, string fldDesc)
        {
            var fldIdParameter = fldId.HasValue ?
                new ObjectParameter("fldId", fldId) :
                new ObjectParameter("fldId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_tblGuestInfoUpdate", fldIdParameter, fldNameParameter, fldFamilyParameter, fldCodeMeliParameter, fldMobileParameter, fldMunIdParameter, fldPassswordParameter, fldDescParameter);
        }
    
        public virtual int sp_UpdateGuestInfoId(string fieldName, string fldid, Nullable<int> guestInfoId, Nullable<int> fldUserID)
        {
            var fieldNameParameter = fieldName != null ?
                new ObjectParameter("fieldName", fieldName) :
                new ObjectParameter("fieldName", typeof(string));
            ...
            var guestInfoIdParameter = guestInfoId.HasValue ?
                new ObjectParameter("GuestInfoId", guestInfoId) :
                new ObjectParameter("GuestInfoId", typeof(int));
    
            var fldUserIDParameter = fldUserID.HasValue ?
                new ObjectParameter("fldUserID", fldUserID) :
                new ObjectParameter("fldUserID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_UpdateGuestInfoId", fieldNameParameter, fldidParameter, guestInfoIdParameter, fldUserIDParameter);
        }
    
        public virtual int sp_ForgetPass_VerifyGuestInsert(string fldVerifyCode, Nullable<bool> fldActive_Deactive, Nullable<long> fldGuestInfId)
        {
            var fldVerifyCodeParameter = fldVerifyCode != null ?
                new ObjectParameter("fldVerifyCode", fldVerifyCode) :
                new ObjectParameter("fldVerifyCode", typeof(string));
            ...
            var fldGuestInfIdParameter = fldGuestInfId.HasValue ?
                new ObjectParameter("fldGuestInfId", fldGuestInfId) :
                new ObjectParameter("fldGuestInfId", typeof(long));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_ForgetPass_VerifyGuestInsert", fldVerifyCodeParameter, fldActive_DeactiveParameter, fldGuestInfIdParameter);
        }
    
        public virtual ObjectResult<sp_ForgetPass_VerifyGuestSelect> sp_ForgetPass_VerifyGuestSelect(string fieldname, string value, Nullable<int> h)
        {
            var fieldnameParameter = fieldname != null ?
                new ObjectParameter("fieldname", fieldname) :
                new ObjectParameter("fieldname", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_ForgetPass_VerifyGuestSelect>("sp_ForgetPass_VerifyGuestSelect", fieldnameParameter, valueParameter, hParameter);
        }
    
        public virtual int sp_ForgetPass_VerifyGuestUpdate(Nullable<int> fldId)
        {
            var fldIdParameter = fldId.HasValue ?
                new ObjectParameter("fldId", fldId) :
                new ObjectParameter("fldId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_ForgetPass_VerifyGuestUpdate", fldIdParameter);
        }
    
        public virtual int sp_UserPassGuestUpdate(Nullable<int> id, string pass)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_UserPassGuestUpdate", idParameter, passParameter);
        }
    
        public virtual int sp_tblCentralSamanOrdersInsert(ObjectParameter fldId, Nullable<int> fldMablagh, string fldMunName)
        {
            var fldMablaghParameter = fldMablagh.HasValue ?
                new ObjectParameter("fldMablagh", fldMablagh) :
                new ObjectParameter("fldMablagh", typeof(int));
    
            var fldMunNameParameter = fldMunName != null ?
                new ObjectParameter("fldMunName", fldMunName) :
                new ObjectParameter("fldMunName", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_tblCentralSamanOrdersInsert", fldId, fldMablaghParameter, fldMunNameParameter);
        }
    
        public virtual int sp_tblCentralSamanOrdersUpdate_RefNum(Nullable<int> fldId, string fldRefNum)
        {
            var fldIdParameter = fldId.HasValue ?
                new ObjectParameter("fldId", fldId) :
                new ObjectParameter("fldId", typeof(int));
    
            var fldRefNumParameter = fldRefNum != null ?
                new ObjectParameter("fldRefNum", fldRefNum) :
                new ObjectParameter("fldRefNum", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_tblCentralSamanOrdersUpdate_RefNum", fldIdParameter, fldRefNumParameter);
        }
    
        public virtual ObjectResult<sp_tblCentralSamanOrdersSelect> sp_tblCentralSamanOrdersSelect(string fieldname, string value, Nullable<int> h)
        {
            var fieldnameParameter = fieldname != null ?
                new ObjectParameter("fieldname", fieldname) :
                new ObjectParameter("fieldname", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_tblCentralSamanOrdersSelect>("sp_tblCentralSamanOrdersSelect", fieldnameParameter, valueParameter, hParameter);
        }
    }
}
