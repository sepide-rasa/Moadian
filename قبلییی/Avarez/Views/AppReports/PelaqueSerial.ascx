...
<%{
      ...
      WebReport1.Report.Load(AppDomain.CurrentDomain.BaseDirectory + @"\" + @"\Reports\Rpt_PlaqueSerial.frx");
      WebReport1.RegisterData(dt,"complicationsCarDBDataSet1");
...
<form runat="server" dir="ltr" >
<cc1:WebReport ID="WebReport1" runat="server" Width="100%" Height="100%" style="direction:ltr;" Font-Names="Tornado Tahoma" ToolbarIconsStyle="Green" ToolbarStyle="Large" PrintInPdf="true" PrintInBrowser="false" />
</form>