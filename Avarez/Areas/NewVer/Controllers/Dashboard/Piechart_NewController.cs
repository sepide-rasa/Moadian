...
{
    public class Piechart_NewController : Controller
    {
        //
        // GET: /NewVer/Piechart_New/

        public ActionResult Index(string containerId)
        {
            if (Session["UserId"] == null)
                return RedirectToAction("LogOn", "Account_New");
            Avarez.Models.OnlineUser.UpdateUrl(Session["UserId"].ToString(), "داشبورد->نمودار خودروهای ماه جاری");
