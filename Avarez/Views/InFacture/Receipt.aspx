...
<%{
      ...
      var q = car.rpt_Receipt(Convert.ToInt32(Session["ResidId"]), Convert.ToInt32(Session["Type"])).FirstOrDefault();
      if (q == null)
          return;
      ...
      resid.Fill(dt.rpt_Receipt, Convert.ToInt32(Session["ResidId"]), Convert.ToInt32(Session["Type"]));
