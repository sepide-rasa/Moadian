...
<%{
      ...
      Collection.Fill(dt.sp_RptCollection, Convert.ToInt32(Session["UserMnu"]), MyLib.Shamsi.Shamsi2miladiDateTime(Session["start"].ToString()), MyLib.Shamsi.Shamsi2miladiDateTime(Session["end"].ToString()));
      ...
      WebReport1.Report.Load(AppDomain.CurrentDomain.BaseDirectory + @"\" + @"\Reports\rptCollection.frx");
      ...
      WebReport1.Report.SetParameterValue("MyTablighat", MyTablighat); 
