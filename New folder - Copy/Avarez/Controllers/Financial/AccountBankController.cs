...
namespace Avarez.Controllers.Financial
{
    ...
    public class AccountBankController : Controller
    {
        ...
        public ActionResult Fill([DataSourceRequest] DataSourceRequest request)
        {
            ...
            var q = m.sp_AccountBankSelect("", "", 30, Convert.ToInt32(Session["UserId"]), Session["UserPass"].ToString()).ToList().ToDataSourceResult(request);
            return Json(q);
        ...
        public JsonResult GetCascadeCounty(int cboBank)
        {
            Models.cartaxEntities car = new Models.cartaxEntities();
        ...
        {//جستجو
            string[] _fiald = new string[] { "fldID", "fldBranchName", "fldAccountNumber" };
            string[] searchType = new string[] { "%{0}%", "{0}%", "{0}" };
            string searchtext = string.Format(searchType[searchtype], value);
            Models.cartaxEntities m = new Models.cartaxEntities();
            var q = m.sp_AccountBankSelect(_fiald[Convert.ToInt32(field)], searchtext, top, Convert.ToInt32(Session["UserId"]), Session["UserPass"].ToString()).ToList();
        ...
        {//نمایش اطلاعات جهت رویت کاربر
            try
            {
                ...
                return Json(new
                {
                    ...
                    fldBranchID=AccountBank.fldBranchID,
                    fldBankID=AccountBank.fldBankID,
