                ...
                {//ثبت رکورد جدید
                    if (Permossions.haveAccess(Convert.ToInt32(Session["UserId"]), 238))
                    {
                        ...
                        if(Session["savePath"] != null)
                            isupload=true;
                        else  if(Session["savePath1"] != null && Session["savePath3"] != null)
                            isupload=true;
                        else if(Session["savePath2"] != null)
                            isupload=true;
                        if (ForceScan == true && isupload == false)
                        {
                            return Json(new { data = "لطفا فایل مدرک را آپلود کنید.", state = 1 });
                        }
                        else
                        {
                            //if (ForceScan==true && (Session["savePath"] != null || Session["savePath1"] != null || Session["savePath2"] != null || Session["savePath3"] != null))
                            //{
                            ...
                            Car.sp_CarFileInsert(CarFileid, Convert.ToInt64(_Carid.Value), care.fldCarPlaqueID,
                                ...
                                Sanadfileid, CartBack, false, null, null, null);
                ...
                {//ویرایش رکورد ارسالی
                    if (Permossions.haveAccess(Convert.ToInt32(Session["UserId"]), 240))
                    {
                        ...
                        Car.sp_CarFileUpdate(care.fldID, care.fldCarID, care.fldCarPlaqueID,
                            ...
                            Bargsabzfileid, Cartfileid, Sanadfileid, CartBack,null);
