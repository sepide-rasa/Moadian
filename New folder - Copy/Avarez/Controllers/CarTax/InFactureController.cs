...
namespace Avarez.Controllers.CarTax
{
    public class InFactureController : Controller
    {
        ...
        {            
            ...
            if (carex != null)
            {
                foreach (var item in carex)
                {
                    ...
                    DateTime dt2 = DateTime.Parse("2017/04/19");
        ...
        public ActionResult PcPosPay(string Mablagh, string PosIPId, long carid)
        {
        ...
        public ActionResult FishReport(long id)
        {
            if (Permossions.haveAccess(Convert.ToInt32(Session["UserId"]), 248))
            {
                Models.cartaxEntities p = new Models.cartaxEntities();
        ...
        public ActionResult GoToOnlinePay(decimal Amount, long CarId, int BankId)
        {
            //Amount = 1000;
            Models.cartaxEntities p = new Models.cartaxEntities();
            string Tax = "";
        ...
        {
            Models.cartaxEntities p = new Models.cartaxEntities();
            var car = p.sp_SelectCarDetils(Convert.ToInt64(Session["fldCarID1"])).FirstOrDefault();            
        ...
        public ActionResult SendToSupporter(string Year, int CarClassId)
        {
            ...
            if (CarClassId == 0)
            {
                var car = p.sp_SelectCarDetils(Convert.ToInt64(Session["fldCarID3"])).FirstOrDefault();
