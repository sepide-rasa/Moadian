...
namespace Avarez
{
    public class Transaction_Guest
    {
        ...
        public TransactionResult RunTransaction(string WebTUserName, string WebTPass, int countrydivtype, string LocationName, int CarId, int UserId)
        {
            ...
            var y = h.CheckAccountCharge_Guest(WebTUserName, WebTPass, countrydivtype, LocationName);
            ...
            if (y != null)
            {
                ...
                if (y.HaveCharge && y.Type == 2)//Type=2 --> کاربر تراکنشی
                {
                    ...
                    if (Trans != null)
                    {
                        ...
                        {
                            bool Tr = h.Transaction_Guest(WebTUserName, WebTPass, countrydivtype, LocationName);
                            if (Tr == true)
                            {
