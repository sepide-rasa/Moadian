...
{
    public class State_NewController : Controller
    {
        //
        // GET: /NewVer/State_New/

        public ActionResult Index(string containerId)
        {
            if (Session["UserId"] == null)
                return RedirectToAction("LogOn", "Account_New");
            Avarez.Models.OnlineUser.UpdateUrl(Session["UserId"].ToString(), "اطلاعات پایه->تعریف استان");
        ...
        public ActionResult Read(StoreRequestParameters parameters)
        {
            ...
            List<Avarez.Models.sp_StateSelect> data = null;
            if (filterHeaders.Conditions.Count > 0)
            {
                string field = "";
                string searchtext = "";
                List < Avarez.Models.sp_StateSelect > data1 = null;
                foreach (var item in filterHeaders.Conditions)
                {
                    ...
                    if (data != null)
                        data1 = m.sp_StateSelect(field, searchtext, 100, Convert.ToInt32(Session["UserId"]), Session["UserPass"].ToString()).ToList();
                    else
                        data = m.sp_StateSelect(field, searchtext, 100, Convert.ToInt32(Session["UserId"]), Session["UserPass"].ToString()).ToList();
                }
            ...
            {
                data = m.sp_StateSelect("", "", 100, Convert.ToInt32(Session["UserId"]), Session["UserPass"].ToString()).ToList();
            }
            ...
            List<Avarez.Models.sp_StateSelect> rangeData = (parameters.Start < 0 || limit < 0) ? data : data.GetRange(parameters.Start, limit);
            //-- end paging ------------------------------------------------------------
